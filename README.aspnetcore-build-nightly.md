...
- [`1.1.12-1.1.13-nanoserver-sac2016`, `1.1.12-1.1.13`, `1.1`, `1` (*1.1/nanoserver-sac2016/sdk/Dockerfile*)](https://github.com/aspnet/aspnet-docker/blob/dev/1.1/nanoserver-sac2016/sdk/Dockerfile)
- For 2.1 and up, use [microsoft/dotnet-nightly][migrate].
